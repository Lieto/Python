...
facts and functionalitites of graphs.
"""
...
class Graph(object):
    ...
    def find_isolated_verticces(self):
    ...
    def erdoes_gallai(dsequence):
        """ Check if the condition of the Erdoes-Gallai inequality
        is fullfilled
    ...
    def density(self):
        """ method to calculate the denisty of a graph """
    ...
    def is_connected(self, vertices_encountered = None, start_vertex = None):
        ...
        vertices = list(gdict.keys()) # 'list' necessay in Python 3
        if not start_vertex:
